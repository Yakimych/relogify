...
module Types = {
  [@ocaml.warning "-30"];
  type response_insert_community_settings_one = {id: string}
  ...
  type response = {
    insert_community_settings_one:
      option(response_insert_community_settings_one),
  };
  type rawResponse = response;
  type variables = {input: community_settings_insert_input};
};

module Internal = {
  type wrapResponseRaw;
  let wrapResponseConverter: Js.Dict.t(Js.Dict.t(Js.Dict.t(string))) = [%raw
    {json| {"__root":{"insert_community_settings_one":{"n":""}}} |json}
  ];
...
module Utils = {
  ...
  let make_response_insert_community_settings_one =
      (~id): response_insert_community_settings_one => {
    id: id,
  };

  let makeOptimisticResponse =
      (~insert_community_settings_one=?, ()): rawResponse => {
    insert_community_settings_one: insert_community_settings_one,
  };
};
...
v1 = [
  {
    ...
    "kind": "LinkedField",
    "name": "insert_community_settings_one",
    "plural": false,
    "selections": [
      {
        "alias": null,
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "EditSettings_CreateCommunitySettings_Mutation",
    "selections": (v1/*: any*/),
    "type": "mutation_root",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "fa003c5e172361519b3fb5160e028077",
    "id": null,
    "metadata": {},
    "name": "EditSettings_CreateCommunitySettings_Mutation",
    "operationKind": "mutation",
    "text": "mutation EditSettings_CreateCommunitySettings_Mutation(\n  $input: community_settings_insert_input!\n) {\n  insert_community_settings_one(object: $input) {\n    id\n  }\n}\n"
  }
};
})() |json}
];
